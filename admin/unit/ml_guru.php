...
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['id_nik']; ?>&nbsp;</td>
<td style="width:80px;" align="center">&nbsp;<?php echo $dupdate['namag']; ?>&nbsp;</td>
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['jk']; ?>&nbsp;</td>
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['tgl_lahir']; ?>&nbsp;</td>
<td style="width:150px;" align="center">&nbsp;<?php echo $dupdate['alamat']; ?>&nbsp;</td>
<td style="width:60px;" align="center">&nbsp;<?php echo $dupdate['no_hp']; ?>&nbsp;</td>
</tr>
</tbody>
